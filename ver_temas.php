        ...
        <div class="overlay">
            <div class="container">
                ...
                <div class="search-container">
                    <input type="text" id="buscador" placeholder="🔍 Buscar tema por título..." onkeyup="filtrarTemas()">
                </div>

                <div class="header-actions">
                    <a href="crear_tema.php" class="btn-crear">➕ Crear Nuevo Tema</a>
                    <div style="margin-top: 15px;">
                        <a href="index.php" class="btn-volver" style="font-size: 0.9em; opacity: 0.8;">
                            🏠 Volver a la Base
                        </a>
                    </div>
                </div>
        ...
        <script>
            function filtrarTemas() {
                ...
                for (let i = 0; i < tarjetas.length; i++) {
                    // Buscamos en el título (h3)
                    let titulo = tarjetas[i].getElementsByTagName('h3')[0].innerText.toLowerCase();
                    // Opcional: También busca en la descripción (pre)
                    let descripcion = tarjetas[i].getElementsByTagName('pre')[0].innerText.toLowerCase();
