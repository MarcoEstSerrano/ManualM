    ...
    <style>
        ...
        body { 
            ...
            background-image: linear-gradient(rgba(0,0,0,0.85), rgba(0,0,0,0.85)), 
                              url('https://images.alphacoders.com/131/1310655.jpeg');
        ...
        .overlay { min-height: 100vh; width: 100%; display: flex; justify-content: center; padding-top: 40px; }
        ...
        /* Buscador */
        #buscador {
            width: 100%; padding: 15px; border: 1px solid rgba(0, 242, 255, 0.3);
        ...
        .tema-card::after {
            ...
            font-size: 8px; opacity: 0.3; letter-spacing: 2px;
        }

        h3 { margin-top: 0; color: white; text-transform: uppercase; }
        ...
        .actions a {
            font-size: 0.8em; text-transform: uppercase; font-weight: bold; margin-right: 15px;
        }
    </style>
</head>
<body>
